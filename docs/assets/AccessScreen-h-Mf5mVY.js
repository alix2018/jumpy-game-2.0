var d=Object.defineProperty;var p=(n,e,s)=>e in n?d(n,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):n[e]=s;var i=(n,e,s)=>p(n,typeof e!="symbol"?e+"":e,s);import{C as v,S as y,T as m}from"./pixi-C09EVf57.js";class f{constructor(e,s,r,l,u){i(this,"container");i(this,"overlay");i(this,"input");i(this,"submit_button");i(this,"error_message");i(this,"sync_position");this.app=e,this.container=new v;const h=s<r?"/assets/background-settings-mobile.png":"/assets/background-settings.png",o=new y(m.from(h));o.width=s,o.height=r,this.container.addChild(o),e.stage.addChild(this.container),this.overlay=document.createElement("div"),this.overlay.className="access-overlay",this.overlay.innerHTML=`
